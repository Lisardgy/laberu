    ...
    <q-header elevated>
      <div class="text-white toolbarT">
        <q-toolbar class="row full-height justify-center">
          ...
          <q-space />
          <div class="user">
            <div class="text-h6 text-center">labelru@gmail.com</div>
          </div>
          <q-btn
            flat
            round
...
<!-- <q-item>
                    ...
                    <q-item-section>List item</q-item-section>
                    <q-fab color="grey-5"  icon="keyboard_arrow_right" direction="right">
                      <q-item-action @click="onClick">
                        ...
                        >
                          <q-page-container>
                            ...
                            <q-page class="q-pa-md">
                              ...
                              <q-card class="my-carddetail" style="width:100%">
                                <img
                                  src="https://cdn.quasar.dev/img/mountains.jpg"
                                  style="width:100%"
                                />
